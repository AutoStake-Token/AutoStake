    ...
    return (
        <div tw="relative" id="about">
            <div tw="flex flex-col items-center justify-center relative py-24 px-8">
                <div tw=" flex flex-row items-start justify-center mb-24  md:col-span-2 row-start-1 md:(col-start-2 row-start-1) text-3xl md:text-6xl">
                    <span tw="text-xl color[var(--green)] mr-4 ">01</span>
                    <span className="text-glow" tw="text-center color[var(--green)]">Welcome to AutoStake</span>
                </div>
