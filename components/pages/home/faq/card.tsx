...
function Card({ data }) {
    ...
    return (
        <div
            css={[
                tw`flex flex-col  space-y-4 text-center border-color[var(--greenDark)] border-b-2`,
        ...
        >
            ...
            <div
                ...
                <div
                    css={[
                        tw`w-6 cursor-pointer fill-current color[var(--green)] transform -rotate-180`,
                    ...
                    >
                        <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                            <g stroke="var(--green)" strokeWidth="2" transform="translate(-725 -5658)">
            ...
            {/* bottom para */}
            {expanded && <span tw="flex flex-col text-2xl py-10 px-4 font-medium  color[var(--green)] ">
                {data.answer}
            </span>}
