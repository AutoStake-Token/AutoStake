    ...
    <div id="faq" tw="flex bg-cover min-h-screen  ">
      <div tw="flex flex-col flex-1 items-center space-y-12 justify-center  py-8 px-4 md:px-32">
        <div tw="flex items-start">
          ...
          <h1
            className="text-glow"
            tw="text-4xl lg:text-7xl color[var(--green)] md:text-center "
          >
        ...
        {/* <span
          ...
          tw="border border-color[var(--green)] color[var(--greenDark)]  text-3xl  py-4 px-10 rounded-sm cursor-pointer"
