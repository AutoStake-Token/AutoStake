...
function Team({ data }) {
    return (
        <div className="gradient" tw="flex  flex-col items-center justify-end mb-32  height[250px] width[300px] relative ">
            ...
            <div tw="absolute top[-35%] rounded-full h-44 w-44 bg-gray-800 overflow-hidden">
                <img src={"/assets/images/team/" + data.picture + ".png"} alt="" />
            </div>

            <div tw="flex flex-col items-center space-y-4 py-4 w-full">
                <h2 tw="text-3xl color[#f4003a] font-bold uppercase font-family[Bungee]">{data.name.split(" ")[0]}</h2>
